...
if (app()->isLocal()) {
    Route::prefix('dev-seed')->name('dev.seed.')->group(function () {
        Route::post('/run-migrations', [SeedController::class, 'runMigrations'])->name('migrations');
        Route::post('/test-video-insert', [SeedController::class, 'testVideoInsert'])->name('test-video');
        Route::post('/clear-workouts', [SeedController::class, 'clearWorkouts'])->name('clear-workouts');
        Route::post('/clear-exercises', [SeedController::class, 'clearExercises'])->name('clear-exercises');
        Route::post('/workouts-portfolio', [SeedController::class, 'seedWorkoutsPortfolio'])->name('workouts-portfolio');
        Route::post('/goals', [SeedController::class, 'seedGoals'])->name('goals');
        Route::post('/portfolio', [SeedController::class, 'seedPortfolio'])->name('portfolio');
    });
}
