...
class WorkoutService
{
    ...
    public function __construct(CalorieCalculatorService $calorieCalculator)
    {
    ...
    public function completeWorkout(Workout $session, array $completionData): Workout
    {
        ...
        Log::info('Workout session completed', ['session_id' => $session->id]);
        return $session;
    }
    ...
    {
        $user->workouts()->inProgress()->get()->each(function ($workout) {
